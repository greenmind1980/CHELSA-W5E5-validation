...
# does not contain a loop over the variables. The output directory is currently set to
# an empty folder. Sub-folders for each variable can be created if needed. 
...
con = dbConnect(pg, user="harichan", password="Lampe948769" ,host="postgres.wsl.ch", port=5432, dbname="ghcn")
